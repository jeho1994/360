 ...
 * starting date, salary, and skills used at workplace, for a student.
 * 
 * @author Jieun Lee
 * @version 11-19-2016
 */
public class StudentEmployment {
	...
	/**
	 * (Full constuctor) Constructs a StudentEmployment with the given
	 * employment data. It is used when employment information is available.
	 * 
	 * @param theUwnetId
	 * @param theEmployer
	 * @param thePosition
	...
	/**
	 * Constructs a StudentEmployment with the given employment data. It is used
	 * when employment information is available.
	 * 
	 * @param theUwnetId
	 * @param theEmployer
	 * @param thePosition
