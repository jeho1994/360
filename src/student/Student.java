...
/**
 * The Student class represents a unique University of Washington
 * Tacoma Institute of Technology student.
...
public class Student 
{
	...
	/**
	 * Constructs a new student with first name, last name, student 
	 * number, and a UW Net ID.
	 * @param firstName
	 * @param lastName
	 * @param studentNumber
	 * @param uwNetID
	...
	/**
	 * Constructs a new student with first name, last name, student 
	 * number, and a UW Net ID, and an e-mail.
	 * @param firstName
	 * @param lastName
	 * @param email
	 * @param studentNumber
	...
	/**
	 * Constructs a new student with a first name, last name,
	 * student number, UW Net ID, and degree information.
	 * @param firstName
	 * @param lastName
	 * @param studentNumber
	 * @param uwNetID
	...
	/**
	 * Constructs a student with a first name, last name, 
	 * student number, UW Net ID, e-mail, and degree information.
	 * @param firstName
	 * @param lastName
	 * @param email
	 * @param studentNumber
	...
	/**
	 * Returns the student's internship information.
	 * @return intern
	 */
